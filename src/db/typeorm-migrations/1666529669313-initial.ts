...
export class initial1666529669313 implements MigrationInterface {
    name = 'initial1666529669313'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product_brand" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "name" character varying NOT NULL, "slug" character varying NOT NULL, "order" integer NOT NULL, CONSTRAINT "UQ_0f65346d968b04d48820e510aaa" UNIQUE ("slug"), CONSTRAINT "PK_2eb5ce4324613b4b457c364f4a2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_fd6932e3e38c0f12af475aa5bf" ON "product_brand" ("order") `);
        await queryRunner.query(`CREATE TABLE "size_group" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "slug" character varying NOT NULL, "title" character varying NOT NULL, "order" integer NOT NULL, CONSTRAINT "UQ_d137e509d2260ebf28fb241e2e2" UNIQUE ("slug"), CONSTRAINT "PK_1bbc6ececd6336c0ac2e7f325d5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_21321ce5cacf6d53e5a1056fb6" ON "size_group" ("order") `);
        await queryRunner.query(`CREATE TABLE "product_category" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "name" character varying NOT NULL, "slug" character varying NOT NULL, "path" character varying NOT NULL, "parentId" integer, "sizeGroupId" integer, "synonyms" jsonb NOT NULL DEFAULT '[]', "order" integer NOT NULL, CONSTRAINT "UQ_e0f84f926a4606a6529b4770146" UNIQUE ("path"), CONSTRAINT "UQ_8b07f4d11a7e8d6c30a872bb7fd" UNIQUE ("slug", "parentId"), CONSTRAINT "UQ_02fc691b1b759dc76912afcfd4d" UNIQUE ("name", "parentId"), CONSTRAINT "PK_0dce9bc93c2d2c399982d04bef1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_275bd9a3b0e72e9df1a7486e4e" ON "product_category" ("order") `);
        await queryRunner.query(`CREATE TABLE "product_condition" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "explanation" character varying NOT NULL, "order" integer NOT NULL, CONSTRAINT "UQ_189aa23f6d69e9b9513f1845162" UNIQUE ("title"), CONSTRAINT "PK_2a6ba7b92d21ca854c3aa2f5022" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "color" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "title" character varying NOT NULL, "hex" character varying NOT NULL, "order" integer NOT NULL, "code" character varying NOT NULL, CONSTRAINT "UQ_fe74918a1db4c69c9efa0ee1c0c" UNIQUE ("code"), CONSTRAINT "PK_d15e531d60a550fbf23e1832343" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "size" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "sizeGroupId" integer NOT NULL, "title" character varying NOT NULL, "order" integer NOT NULL, CONSTRAINT "PK_66e3a0111d969aa0e5f73855c7a" PRIMARY KEY ("id"))`);
